...
5. After creating the repository, fill out the [registration form](https://vibelympics.splashthat.com/). For the field labeled "repository URL," share the link to the repository you just created.
